  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-8">Effective date: 2025-10-01</p>

        <div className="prose prose-slate max-w-none space-y-8 text-foreground">
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">1. Introduction</h2>
            <p>
              Welcome to <strong>VerseDrop</strong>.
            </p>
            <p>
              <strong>VerseDrop</strong> ("us", "we", or "our") operates <strong>www.versedrop.in</strong> (hereinafter referred to as <strong>"Service"</strong>).
            </p>
            <p>
              Our Privacy Policy governs your visit to <strong>www.versedrop.in</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.
            </p>
            <p>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>SERVICE</strong> means the www.versedrop.in website operated by VerseDrop.</li>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">3. Information Collection and Use</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">4. Types of Data Collected</h2>
          ...
          <section>
            ...
            <p>VerseDrop uses the collected data for various purposes:</p>
            <ul className="list-disc pl-6 space-y-2 mt-4">
          ...
          <section>
            ...
            <p>
              VerseDrop will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">8. Disclosure of Data</h2>
            <p>We may disclose personal information that we collect, or you provide:</p>
            
            <h3 className="text-xl font-semibold mt-6 mb-3">8.1. Disclosure for Law Enforcement.</h3>
            <p>
              Under certain circumstances, we may be required to disclose your Personal Data if required to do so by law or in response to valid requests by public authorities.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">8.2. Business Transaction.</h3>
            <p>
              If we or our subsidiaries are involved in a merger, acquisition or asset sale, your Personal Data may be transferred.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">8.3. Other cases. We may disclose your information also:</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</h2>
            <p>
            ...
            <p>
              If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <strong>contact@versedrop.in</strong>.
            </p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</h2>
            <p>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-4">
              ...
              <li>users are able to change their personal information by emailing us at <strong>contact@versedrop.in</strong>.</li>
            </ul>
            <p className="mt-4"><strong>Our Policy on "Do Not Track" Signals:</strong></p>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</h2>
            <p>
              If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data and not to sell (share) it. To exercise your data protection rights, you can make certain requests and ask us:
            </p>
            <p className="mt-4"><strong>12.1. What personal information we have about you. If you make this request, we will return to you:</strong></p>
            <ul className="list-disc pl-6 space-y-2 mt-2">
            ...
            <p className="mt-4">
              To exercise your California data protection rights described above, please send your request(s) by email: <strong>contact@versedrop.in</strong>.
            </p>
            <p className="mt-4">
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">13. Service Providers</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">16. Behavioral Remarketing</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">18. Links to Other Sites</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">19. Children's Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="text-2xl font-bold mt-8 mb-4">20. Changes to This Privacy Policy</h2>
            <p>
          ...
          <section>
            ...
            <p>
              If you have any questions about this Privacy Policy, please contact us by email: <strong>contact@versedrop.in</strong>.
            </p>
            <p className="mt-4 text-sm text-muted-foreground">
              This Privacy Policy was created for <strong>www.versedrop.in</strong> by PolicyMaker.io on 2025-10-01.
            </p>
          </section>
        </div>
      </main>
