  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1">
        ...
        >
          <div className="container mx-auto px-2 md:px-2 py-[11rem]">
        ...
        <section className="w-full py-16 bg-black">
          <div className="max-w-none w-full px-0">
            <h2 className="text-3xl md:text-4xl font-extrabold uppercase tracking-wide mb-10 text-center text-white">
              ...
              {[
                {
                  ...
                  barcode: "src/assets/Spotify_Code.svg",
                },
                {
                  name: "FUBU",
                  cover: fubu,
                  spotify: "https://open.spotify.com/album/1gMI7E8geD2zjlDj9oTIp1",
                  barcode: "https://i.ibb.co/6bQ7QpT/spotify-barcode.png",
                },
                {
                  name: "WOH",
                  cover: woh,
